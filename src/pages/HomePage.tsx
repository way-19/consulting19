...
import {
  ArrowRight, Bot, Shield, Zap, MessageSquare, Users, Globe2,
  TrendingUp, Clock, Building, CheckCircle, Calculator, Scale,
...
const HomePage = () => {
  ...
  const aiFeatures = [
    ...
    },
    {
      ...
      description:
        "24/7 AI assistance with human expert backup when needed",
      color: "bg-purple-500",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Expert Services (cards clickable; 2 kart kaldırıldı) */}
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Not: Digital Nomad Services & Wealth Management kaldırıldı */}
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                excerpt:
                  'Comprehensive guide to UAE free zones and their advantages for technology startups.',
              ...
              },
              {
                ...
                excerpt:
                  "How Estonia's e-Residency program is revolutionizing remote business operations.",
