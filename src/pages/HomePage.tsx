        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              across our global network of strategic jurisdictions.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Complete business registration and setup services across 127+ countries',
                features: ['LLC/Corporation setup', 'Legal documentation', 'Compliance support'],
                color: 'bg-blue-500'
              },
              {
                icon: CreditCard,
                title: 'Banking Solutions',
                description: 'International banking and financial services for global businesses',
                features: ['Account opening', 'Multi-currency support', 'Online banking'],
                color: 'bg-green-500'
              },
              {
                icon: Scale,
                title: 'Legal & Compliance',
                description: 'Expert legal guidance and regulatory compliance across jurisdictions',
                features: ['Legal consultation', 'Contract review', 'Regulatory compliance'],
                color: 'bg-purple-500'
              },
              {
                icon: Calculator,
                title: 'Tax Optimization',
                description: 'Strategic tax planning and optimization for international businesses',
                features: ['Tax residency', 'Structure optimization', 'Compliance monitoring'],
                color: 'bg-orange-500'
              },
              {
                icon: FileText,
                title: 'Document Services',
                description: 'Professional document preparation and certification services',
                features: ['Document preparation', 'Apostille services', 'Translation'],
                color: 'bg-indigo-500'
              },
              {
                icon: Users,
                title: 'Ongoing Support',
                description: '24/7 expert support and consultation for your business needs',
                features: ['Dedicated consultant', 'Priority support', 'Regular check-ins'],
                color: 'bg-red-500'
              }
            ].map((service, index) => (
              <div key={index} className="group relative bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className={`inline-flex items-center justify-center w-16 h-16 ${service.color} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-200`}>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <Link
                    to="/services"
                    className="text-purple-600 hover:text-purple-700 font-medium text-sm flex items-center space-x-1 group-hover:space-x-2 transition-all"
                  >
          ...
          <div className="text-center mt-12">
            <Link
              to="/services"
              className="inline-flex items-center space-x-2 bg-purple-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-purple-700 transition-colors shadow-lg hover:shadow-xl"
            >
