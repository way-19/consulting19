...
const ServicesPage = () => {
  ...
  const stats = {
    ...
    totalOrders: services.reduce((sum, s) => sum + (s.orders_count || 0), 0),
    totalRevenue: services.reduce((sum, s) => sum + (s.total_revenue || 0), 0)
  };
    ...
    <ConsultantLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">My Custom Services</h2>
            <p className="text-gray-600">Create and manage your custom service offerings</p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create your first custom service to offer specialized solutions to clients.</p>
            <button
              onClick={() => setShowForm(true)}
