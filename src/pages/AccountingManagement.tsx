          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search client, document or task..."
                  value={searchTerm}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600 mb-3">
                            ...
                            <div>
                              ...
                              <span className={document.due_date && new Date(document.due_date) < new Date() ? 'text-red-600 font-medium' : ''}>
                                {document.due_date ? new Date(document.due_date).toLocaleDateString() : 'None'}
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600">
                            ...
                            <div>
                              ...
                              {task.estimated_hours ? `${task.estimated_hours}h estimated` : 'None'}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600">
                            ...
                            <div>
                              <span className="font-medium">Due Date:</span> 
                              {reminder.due_date ? new Date(reminder.due_date).toLocaleDateString() : 'None'}
                            </div>
                            <div>
